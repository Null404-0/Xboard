...
class UserAssignController extends Controller
{
    /**
     * 获取节点当前分配的用户列表
     * GET /server/userAssign/fetch?server_id=1
     */
    public function fetch(Request $request)
    {
        ...
        $userIds = ServerUser::where('server_id', $request->input('server_id'))
            ->pluck('user_id');
    ...
    public function save(Request $request)
    {
        ...
        ServerUser::where('server_id', $serverId)->delete();
